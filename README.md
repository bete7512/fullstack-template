...
Planned next: authentication (JWT, refresh tokens, Google login), authorization, background jobs, observability, a Next.js frontend, and deployment to AWS ECS with Terraform.
...
curl 'localhost:8080/v1/users?limit=10&sort_by=email&sort_dir=asc'
```
